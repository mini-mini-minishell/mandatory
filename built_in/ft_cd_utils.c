...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/14 20:20:18 by hogkim            #+#    #+#             */
/*   Updated: 2022/09/14 20:20:22 by hogkim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	do_replace(t_cmd *cmd, char *pwd, char *key)
{
	...
	list_push_back(cmd->envp_list, \
				list_new_node(create_envp_data(key, ft_strdup(pwd))));
